...
object GreeterGrpc {
  val METHOD_SAY_HELLO: _root_.io.grpc.MethodDescriptor[greeter.HelloRequest, greeter.HelloReply] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      .setType(_root_.io.grpc.MethodDescriptor.MethodType.UNARY)
      .setFullMethodName(_root_.io.grpc.MethodDescriptor.generateFullMethodName("Greeter", "SayHello"))
      .setSampledToLocalTracing(true)
      .setRequestMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[greeter.HelloRequest])
      .setResponseMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[greeter.HelloReply])
      .setSchemaDescriptor(_root_.scalapb.grpc.ConcreteProtoMethodDescriptorSupplier.fromMethodDescriptor(greeter.GreeterProto.javaDescriptor.getServices().get(0).getMethods().get(0)))
      .build()
  
  val SERVICE: _root_.io.grpc.ServiceDescriptor =
    _root_.io.grpc.ServiceDescriptor.newBuilder("Greeter")
      .setSchemaDescriptor(new _root_.scalapb.grpc.ConcreteProtoFileDescriptorSupplier(greeter.GreeterProto.javaDescriptor))
  ...
  trait Greeter extends _root_.scalapb.grpc.AbstractService {
    ...
    /** Sends a greeting
      */
    def sayHello(request: greeter.HelloRequest): scala.concurrent.Future[greeter.HelloReply]
  }
  ...
  object Greeter extends _root_.scalapb.grpc.ServiceCompanion[Greeter] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.ServiceDescriptor = greeter.GreeterProto.javaDescriptor.getServices().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.ServiceDescriptor = greeter.GreeterProto.scalaDescriptor.services(0)
    def bindService(serviceImpl: Greeter, executionContext: scala.concurrent.ExecutionContext): _root_.io.grpc.ServerServiceDefinition =
      ...
      .addMethod(
        METHOD_SAY_HELLO,
        _root_.io.grpc.stub.ServerCalls.asyncUnaryCall(new _root_.io.grpc.stub.ServerCalls.UnaryMethod[greeter.HelloRequest, greeter.HelloReply] {
          override def invoke(request: greeter.HelloRequest, observer: _root_.io.grpc.stub.StreamObserver[greeter.HelloReply]): _root_.scala.Unit =
  ...
  trait GreeterBlockingClient {
    ...
    /** Sends a greeting
      */
    def sayHello(request: greeter.HelloRequest): greeter.HelloReply
  }
  ...
  class GreeterBlockingStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[GreeterBlockingStub](channel, options) with GreeterBlockingClient {
    /** Sends a greeting
      */
    override def sayHello(request: greeter.HelloRequest): greeter.HelloReply = {
  ...
  class GreeterStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[GreeterStub](channel, options) with Greeter {
    /** Sends a greeting
      */
    override def sayHello(request: greeter.HelloRequest): scala.concurrent.Future[greeter.HelloReply] = {
